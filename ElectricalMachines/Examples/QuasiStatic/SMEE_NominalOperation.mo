...
model SMEE_NominalOperation
  ...
  parameter Modelica.SIunits.Torque tau0=185.256354 "Estimated initial torque";
  parameter Modelica.SIunits.Angle gammar0=58.773623*pi/180 "Estimated initial rotor angle";
...
equation
  ...
  connect(excitationCurrent.n, smee.pin_ep)
    annotation (Line(points={{-30,-10},{-30,-4},{-10,-4}},
                                                       color={0,0,255}));
  connect(excitationCurrent.p, smee.pin_en) annotation (Line(points={{-30,-30},
          {-10,-30},{-10,-16}},     color={0,0,255}));
  connect(groundE.p, excitationCurrent.p) annotation (Line(points={{-30,-40},
          {-30,-30}},                color={0,0,255}));
