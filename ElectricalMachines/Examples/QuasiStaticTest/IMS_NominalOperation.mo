...
model IMS_NominalOperation "Nominal operation of induction machine with slipring rotor"
...
equation
  ...
  annotation (experiment(Interval=0.001, Tolerance=1e-06), Documentation(info=
         "<html>
<p>
Nominal operation of quasistatic induction machine with slipring rotor based on nominal stator current
</p>
</html>"));
